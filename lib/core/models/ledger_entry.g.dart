...
class LedgerEntryAdapter extends TypeAdapter<LedgerEntry> {
  ...
  LedgerEntry read(BinaryReader reader) {
    ...
    return LedgerEntry(
      ...
      pvcInFeet: fields[22] as double,
      pvcPerFeetRate: fields[23] as double,
      msPipeInFeet: fields[24] as double,
      msPipePerFeetRate: fields[25] as double,
      stepRate: fields[26] as double,
      isStepRateManuallyEdited: fields[27] as bool,
      vehicleId: fields[28] as String,
      receivedCash: fields[29] as double,
      receivedPhonePe: fields[30] as double,
